...
const AppEsquerda = () => (
  <WebView
    style={styles.painel}
    source={{ uri: 'http://votacao.camarapatos.mg.gov.br/' }} // Mude o site aqui
  />
);
...
const AppDireita = () => (
  <WebView
    style={styles.painel}
    source={{ uri: 'https://www.microsoft.com/pt-br/microsoft-365/onedrive/free-online-cloud-storage' }} // Mude o site aqui
  />
);
